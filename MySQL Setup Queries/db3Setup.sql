...
-- -----------------------------------------------------
-- Table `db3`.`sensortype`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db3`.`sensortype` (
...
-- Table `db3`.`sensor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db3`.`sensor` (
  ...
  CONSTRAINT `sensor_type`
    ...
    REFERENCES `db3`.`sensortype` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);


-- -----------------------------------------------------
-- Table `db3`.`measurement`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db3`.`measurement` (
  `uuid` VARCHAR(36) NOT NULL,
  ...
  CONSTRAINT `sensor_measure`
    ...
    REFERENCES `db3`.`sensor` (`uuid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);


-- -----------------------------------------------------
-- Table `db3`.`sync_sensor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db3`.`sync_sensor` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `sensor_uuid` VARCHAR(36) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `sensor_idx` (`sensor_uuid` ASC),
...
-- -----------------------------------------------------
-- Table `db3`.`sync_measurement`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db3`.`sync_measurement` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `measurement`
    ...
    REFERENCES `db3`.`measurement` (`uuid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
